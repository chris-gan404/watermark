...
from core.jinja2renders import vh, vw, auto_logo, time_with_location
...
if platform.system() == 'Windows':
    ...
    EXIFTOOL_PATH = BASE_DIR / 'exiftool' / 'exiftool'
    ENCODING = 'utf-8'
...
def get_template(template_name: str) -> Template:
    ...
    template.globals['time_with_location'] = time_with_location
    return template
